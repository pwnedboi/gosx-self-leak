...
#ifndef Fonts_fontawesome_icons_h
#define Fonts_fontawesome_icons_h
...
extern const unsigned int FontAwesome_compressed_data[124568/4];

#endif /** !Fonts_fontawesome_icons_h */
