...
#ifndef Thirdparty_plugin_h
#define Thirdparty_plugin_h
 ...
 */
int plugin(void *function, void *replacement, void **original);
 ...
 */
int plugin_byname(const char *function_name, const char *image_name, void *replacement, void **original);
