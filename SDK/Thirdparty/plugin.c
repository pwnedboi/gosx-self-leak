...
int plugin(void *function, void *replacement, void **original_ptr)
{
	...
	if (original_ptr) {
		ret = duplicate_function(function, original_ptr);
	}
...
int plugin_byname(const char *function_name, const char *suggested_image_name, void *replacement, void **original)
{
	/**
	...
	return plugin(function, replacement, original);
}


int duplicate_function(void *function, void **duplicate)
{
