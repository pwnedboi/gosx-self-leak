...
#ifndef SDK_IInputSystem_h
#define SDK_IInputSystem_h
...
public:
    void EnableInput(bool bEnable) {
        typedef void (*oFunc)(void*, bool);
        return Interfaces::Function<oFunc>(this, 11)(this, bEnable);
    }
    
    void EnableMessagePump(bool bEnable) {
        typedef void (*oFunc)(void*, bool);
        return Interfaces::Function<oFunc>(this, 12)(this, bEnable);
    }
    
    bool IsButtonDown(ButtonCode_t code) {
        typedef bool (*oFunc)(void*, ButtonCode_t);
        return Interfaces::Function<oFunc>(this, 15)(this, code);
    }
    
    void ResetInputState() {
        typedef void (*oFunc)(void*);
        return Interfaces::Function<oFunc>(this, 39)(this);
    }
    /*
